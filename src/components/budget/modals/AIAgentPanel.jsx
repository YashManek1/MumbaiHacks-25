      ...
      >
        ...
        >
          ...
          <div className="flex-1 overflow-y-auto p-6 space-y-4">
                  ...
                  <div className="space-y-2">
                    ...
                    {adjustment.options.map((option, idx) => (
                      <motion.button
                        key={idx}
                        onClick={() =>
                          onAdjustmentChoice(adjustment.id, option.type)
                        }
            ...
            {/* Apply All Buttons */}
            {pendingAdjustments.filter((a) => a.status === "pending").length >
              1 && (
              <motion.div
          ...
          <div className="px-6 py-4 border-t border-gray-800 flex items-center justify-between">
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.98 }}
            >
              {pendingAdjustments.filter((a) => a.status === "pending")
                .length === 0
                ? "Done"
                : "Minimize"}
            </motion.button>
